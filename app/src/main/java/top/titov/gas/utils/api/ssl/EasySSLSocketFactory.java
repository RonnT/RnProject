package top.titov.gas.utils.api.ssl;
...
public class EasySSLSocketFactory implements LayeredSocketFactory {
    ...
    private static SSLContext createEasySSLContext() throws IOException {
        ...
        try {
            ...
            InputStream clientStream = MyApp.getAppContext().getResources().openRawResource(R.raw.production_test_client);
            ...
            instream = MyApp.getAppContext().getResources().openRawResource(R.raw.production_test_ca);
