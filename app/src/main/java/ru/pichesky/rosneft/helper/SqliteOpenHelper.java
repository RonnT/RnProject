 ...
 */
class SQLiteAssetHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database, ConnectionSource connectionSource) {
        if (database == null) Logger.d("=> database is null");
        if (connectionSource == null) Logger.d("=> connectionSource is null");
    }
...
class VersionComparator implements Comparator<String> {
     ...
     *
     * @exception com.readystatesoftware.sqliteasset.SQLiteAssetHelper.SQLiteAssetException
    ...
    public int compare(String file0, String file1) {
        ...
        if (!m0.matches()) {
            ...
            throw new com.readystatesoftware.sqliteasset.SQLiteAssetHelper.SQLiteAssetException("Invalid upgrade script file");
        }
